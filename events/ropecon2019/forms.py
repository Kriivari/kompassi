...
class KorttipeliForm(forms.ModelForm, AlternativeProgrammeFormMixin):
    ...
    def get_excluded_field_defaults(self):
        return dict(
            category=Category.objects.get(event__slug='ropecon2019', slug='korttipeli'),
        )
...
class FigupeliForm(forms.ModelForm, AlternativeProgrammeFormMixin):
    ...
    def get_excluded_field_defaults(self):
        return dict(
            category=Category.objects.get(event__slug='ropecon2019', slug='figupeli'),
        )
...
class KokemuspisteForm(forms.ModelForm, AlternativeProgrammeFormMixin):
    ...
    def get_excluded_field_defaults(self):
        return dict(
            category=Category.objects.get(event__slug='ropecon2019', slug='kokemuspiste'),
        )
...
class LautapeliForm(forms.ModelForm, AlternativeProgrammeFormMixin):
    ...
    def get_excluded_field_defaults(self):
        return dict(
            category=Category.objects.get(event__slug='ropecon2019', slug='lautapeli'),
        )
...
class PuheohjelmaForm(forms.ModelForm, AlternativeProgrammeFormMixin):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['category'].queryset = Category.objects.filter(event__slug='ropecon2019', slug__iregex=r'^puhe.+')
    ...
    def get_excluded_field_defaults(self):
        return dict(
            category=Category.objects.get(event__slug='ropecon2019', slug='puheohjelma'),
        )
